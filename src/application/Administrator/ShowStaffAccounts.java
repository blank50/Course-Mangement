...
public class ShowStaffAccounts extends Application{
    public void start(Stage stage){
	    ...
	    gridPane.setVgap(5); 
	    gridPane.setHgap(5);
		TextField showStaffA = new TextField();
		showStaffA.setPromptText("Enter Course ID");
		gridPane.add(showStaffA, 0,0);
		Button showStaffAcc = new Button("Delete Course");
		gridPane.add(showStaffAcc, 1, 0);
