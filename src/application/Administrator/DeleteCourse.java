...
public class DeleteCourse extends Application{
    public void start(Stage stage){
	    ...
	    gridPane.setVgap(5); 
	    gridPane.setHgap(5);
		TextField delCourse = new TextField();
		delCourse.setPromptText("Enter Course ID");
		gridPane.add(delCourse, 0,0);
		Button deltCourse = new Button("Delete Course");
		gridPane.add(deltCourse, 1, 0);
