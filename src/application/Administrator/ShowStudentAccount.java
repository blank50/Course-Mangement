...
public class ShowStudentAccount extends Application{
    ...
    public void start(Stage stage){
	    ...
	    // gridPane.setVgap(5); 
	    // gridPane.setHgap(5);
		// TextField showStud = new TextField();
		// showStud.setPromptText("Enter Course ID");
		// gridPane.add(showStud, 0,0);
		// Button showStudnt = new Button("Delete Course");
		// gridPane.add(showStudnt, 1, 0);  
